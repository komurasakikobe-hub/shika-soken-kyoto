...
def ward(addr):
    m = re.search(r'京都市\s*([^\s0-9０-９]{1,4}区)', addr or "")
...
CATEGORY_ARTICLES = {
    "ct":       [("2026-07-04_CTとマイクロスコープがある京都の歯科を選ぶ理由.html", "CTとマイクロスコープがある京都の歯科を選ぶ理由"),
                 ("2026-07-04_根管治療が上手い京都の歯科医院を見分ける方法.html", "根管治療が上手い京都の歯科医院を見分ける方法")],
    "micro":    [("2026-07-04_CTとマイクロスコープがある京都の歯科を選ぶ理由.html", "CTとマイクロスコープがある京都の歯科を選ぶ理由"),
                 ("2026-07-04_根管治療が上手い京都の歯科医院を見分ける方法.html", "根管治療が上手い京都の歯科医院を見分ける方法")],
    "implant":  [("2026-07-04_京都のインプラント費用とリスクを正しく理解する.html", "京都のインプラント費用とリスクを正しく理解する")],
    "ortho":    [("2026-07-04_京都で矯正は何歳から？選び方を徹底解説.html", "京都で矯正は何歳から？選び方を徹底解説"),
                 ("2026-07-04_歯並びが気になったら｜京都で矯正相談すべきタイミング.html", "歯並びが気になったら｜京都で矯正相談すべきタイミング")],
    "kids":     [("2026-07-04_子どもの虫歯予防｜京都の小児歯科はいつから？.html", "子どもの虫歯予防｜京都の小児歯科はいつから？"),
                 ("2026-07-04_京都で矯正は何歳から？選び方を徹底解説.html", "京都で矯正は何歳から？選び方を徹底解説")],
    "prevent":  [("2026-07-04_予防歯科クリーニングの頻度とメリット｜京都市版.html", "予防歯科クリーニングの頻度とメリット｜京都市版"),
                 ("2026-07-04_子どもの虫歯予防｜京都の小児歯科はいつから？.html", "子どもの虫歯予防｜京都の小児歯科はいつから？")],
    "esthetic": [("2026-07-04_京都ホワイトニング｜種類・費用・選び方を徹底比較.html", "京都ホワイトニング｜種類・費用・選び方を徹底比較"),
                 ("2026-07-04_銀歯を白くしたい！京都でセラミック治療の費用と方法.html", "銀歯を白くしたい！京都でセラミック治療の費用と方法")],
    "kids_fit": [("2026-07-04_子どもの虫歯予防｜京都の小児歯科はいつから？.html", "子どもの虫歯予防｜京都の小児歯科はいつから？")],
}
...
<header class="odr-brandbar">
  <a class="odr-sig" href="../../index.html">
    ...
    <span class="odr-sig-name">京都歯科総研<small>Osaka Dental Research Institute</small></span>
  </a>
  <nav>
...
<main>
  ...
  <div class="odr-cta" style="margin-top:26px;">
    ...
    <p class="s">ご希望の条件をもとに、京都市内 約2,050院からAIが無料でご案内します。</p>

...
const AREA_KEYWORDS = {
  ...
  "中京区（京都市役所前・烏丸御池）": ["京都市中京区", "中京区"],
  "左京区（元田中・茶山）": ["京都市左京区", "左京区"],
  "右京区（西京極・西院）": ["京都市右京区", "右京区"],
  "下京区（四条・京都）": ["京都市下京区", "下京区"],
  "山科区（椥辻・京阪山科）": ["京都市山科区", "山科区"],
  "西京区（桂・上桂）": ["京都市西京区", "西京区"],
  "北区（北大路・北野白梅町）": ["京都市北区", "北区"],
  "南区（西大路・東寺）": ["京都市南区", "南区"],
  "上京区（北野白梅町・今出川）": ["京都市上京区", "上京区"],
  "東山区（祇園四条・東福寺）": ["京都市東山区", "東山区"],
};
